...
\subsection{Vocabulary Extraction}
...
\subsection{Frequency-based Dataframes}
...
information from the test set into preprocessing. I build both the train and test frequency matrices
...
I used Logistic Regression as the frequency-based baseline classifier. Hyperparameters were selected
with Optuna using 5-fold stratified cross-validation on the training set, optimizing macro F1. The
search considered the regularization strength $C$, \texttt{class\_weight}, and the penalty type.
...
macro recall 0.6654, macro F1 0.7154, and ROC-AUC 0.9028.
